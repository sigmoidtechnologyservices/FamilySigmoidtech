...
public class FoldersMedia extends AppCompatActivity {
	...
	protected void onCreate( Bundle bandolo ) {
		...
		setContentView( R.layout.media_folders);
		...
		if( Global.settings.getTree(idAlbero).dirs.isEmpty() && Global.settings.getTree(idAlbero).uris.isEmpty() )
			new Fabulous( this, R.string.add_device_folder ).show();
	}
	...
	void aggiornaLista() {
		...
		for( String cart : cartelle ) {
			View vistaCartella = getLayoutInflater().inflate( R.layout.piece_folder, scatola, false );
		...
		for( String stringUri : uris ) {
			View vistaUri = getLayoutInflater().inflate( R.layout.piece_folder, scatola, false );
